 ...
 * into an application. The Class EmbeddedADS.
 */
public class EmbeddedADS {
	...
	// HashSet<Index<?, ServerEntry, Long>> indexedAttributes = new
	// HashSet<Index<?, ServerEntry, Long>>();
	//
	...
	private void initDirectoryService(File workDir) throws Exception {
		...
		Partition fooPartition = addPartition("sify", "dc=sify,dc=com");
		...
		try {
			...
			DN dnFoo = new DN("dc=sify,dc=com");
...
//					+ "/serverwork");
			File workDir = new File("/opt/cmf/serverwork");
			workDir.mkdirs();
			...
			// Read an entry
			Entry result = ads.service.getAdminSession().lookup(
					new DN("dc=sify,dc=com"));
