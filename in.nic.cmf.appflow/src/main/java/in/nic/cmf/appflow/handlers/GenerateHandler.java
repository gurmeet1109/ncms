...
public class GenerateHandler implements WorkItemHandler {
    ...
    public GenerateHandler(String domain, StatefulKnowledgeSession ksession) {
    ...
    public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
        ...
        try {
            log.methodEntry("GenerateHandler entry");
            ...
            try {
                switch (AppflowHelper.SELECTFLOW
                    ...
                    case delete:
                        log.debug("inside delete of Generate handler.");
                        ...
                        break;
                    case post:
                        log.debug("inside post of Generate handler.");
                        ...
                        responseMap = serviceclient.add(
                                ...
                                (String) processInstance
                                        .getVariable(HelperConstant.ENTITY),
                                responseMap);
                        // log.debug("Response of generate for post:" +
                        // responseMap);
                        String collections = (String) responseMap.get("input")
                                .get("content");
                ...
                processInstance = appflowHelper.finalizer(
                        ...
                        "Generate: ", processInstance, responseMap);
    ...
    private void getRoles(HashMap<String, Object> storableMap) {
        try {
            ...
            log.debug("EntityType Value ::::" + storableMap.get("EntityType"));
            if (((String) storableMap.get("EntityType"))
